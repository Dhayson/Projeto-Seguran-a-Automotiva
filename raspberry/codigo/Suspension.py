...
logging.basicConfig(filename=f"Suspension-{datetime.datetime.now()}.log", level=logging.INFO, format='%(message)s')
...
try:
    ...
    while True:   
        ...
        message = can.Message(arbitration_id=target_id, timestamp=spoofed_time+elapsed_time, data = [0xFF]*8, is_extended_id=False)
